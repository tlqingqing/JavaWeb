...
<!--
body {
	background-image: url(inmage/bg.jpg);
}
-->
</style>
</head>
...
<body>
	<p>&nbsp;</p>
	<p align="center">
		<span class="style2">欢迎管理员登陆</span>
	</p>
	<hr>
	<p>&nbsp;</p>
	<p>&nbsp;</p>
	...
	<form name="form1" method="post" action="AdminServlet">
		<table width="230" border="1" align="center" cellpadding="0"
			cellspacing="0">
			<tr>
		...
		<p align="center">
			<input name="Sub1" type="submit" id="Sub1" value="登陆">
